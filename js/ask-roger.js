...
(function () {
  ...
  var css = [
    ...
    '#ar-nudge{position:fixed;right:20px;bottom:96px;z-index:1100;width:270px;padding:16px 16px 16px 14px;background:#fff;border:1px solid #ddd8d0;border-radius:16px;box-shadow:0 28px 60px -24px rgba(26,26,26,.5);text-align:left}',
    ...
    '#ar-panel{position:fixed;right:20px;bottom:96px;z-index:1200;width:min(92vw,420px);max-height:min(70vh,640px);display:none;flex-direction:column;overflow:hidden;background:#faf8f4;border:1px solid #ddd8d0;border-radius:18px;box-shadow:0 30px 70px -20px rgba(26,26,26,.55)}',
